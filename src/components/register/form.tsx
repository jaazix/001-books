...
const FormReg = () => {
    ...
    const renderForm = (
        ...
        <form onSubmit={sendData}>
                ...
                <div className="form-outline mb-4">
                    <input id="pass" type="password" name="pass" className="form-control" placeholder="Password"  pattern="[A-Za-z0-9]{8,40}" title="La contraseña debe tener al menos 8 caracteres
                ...
                <div className="form-outline mb-4">
                    <input id="confpass" type="password" name="confpass" className="form-control" placeholder="Confirm Password"  pattern="[A-Za-z0-9]{8,40}" title="La contraseña debe tener al menos 8 caracteres
